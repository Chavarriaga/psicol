                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlsemestre" v-model.trim="formData.semestre"  label="Semestre" type="number" placeholder="Escribir Semestre"   step="any"    
                                                    class=" w-full" :class="getErrorClass('semestre')">
                                                    </InputText>
                                                    <small v-if="isFieldValid('semestre')" class="p-error">{{ getFieldError('semestre') }}</small> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'estudiantesedit',
		},
		pagePath: {
			type : String,
			default : 'estudiantes/edit',
		},
		apiPath: {
			type: String,
			default: 'estudiantes/edit',
