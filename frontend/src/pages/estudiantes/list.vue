            ...
            <section class="page-section mb-3" >
                <div class="container-fluid">
                    <div class="grid justify-content-between align-items-center">
                        ...
                        <div  class="col-fixed " >
                            <router-link :to="`/estudiantes/add`">
                    ...
                    <div  class="col comp-grid" >
                        ...
                        <div >
                            <template v-if="showBreadcrumbs && $route.query.tag && !isSubPage">
                                <Breadcrumb :home="{icon: 'pi pi-home', to: '/estudiantes'}" :model="pageBreadCrumb" />
                            </template>
                                    ...
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        <Column  field="documento" header="Documento" >
                                            <template #body="{ data, index }">
                                                <router-link :to="`/estudiantes/view/${data.documento}`">
                                                    {{ data.documento }}
                                                </router-link>
                                            </template>
                                        </Column>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'estudianteslist',
		},
		apiPath: {
			type: String,
			default: 'estudiantes/index',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: "View",
			to: `/estudiantes/view/${data.documento}`,
			icon: "pi pi-eye"
		},
		{
			label: "Edit",
			to: `/estudiantes/edit/${data.documento}`,
			icon: "pi pi-pencil"
		},
		{
			label: "Delete",
